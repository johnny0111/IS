...
def push_data(child, data):
    db_ref = 'https://is-tp2-84eaf-default-rtdb.europe-west1.firebasedatabase.app/' + child + '.json'
    requests.post(db_ref, json={'data': data, 'timestamp': time.time() })
    pass

def put_config(data):
    db_ref = 'https://is-tp2-84eaf-default-rtdb.europe-west1.firebasedatabase.app/config.json' 
